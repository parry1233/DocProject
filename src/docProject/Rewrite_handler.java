...
public class Rewrite_handler extends DefaultHandler
{
	...
	private String fname_string;
	private String lname_string;
	...
	public Rewrite_handler(String id,String pw,String fname,String lname,String dep,String num)
	{
		super();
		id_string=id;
		pw_string=pw;
	...
	public ArrayList<ArrayList<String>> dataReturn()
	{
		...
		allDoc_pw.set(gotcha, pw_string);
		allDoc_fname.set(gotcha, fname_string);
		allDoc_lname.set(gotcha, lname_string);
		allDoc_dep.set(gotcha, dep_string);
		allDoc_num.set(gotcha, phone_string);
